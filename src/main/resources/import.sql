INSERT INTO usuarios (user_admin, user_estado, user_fechanacimiento, user_sexo, user_telefono, user_apellido, user_email, user_nombre, user_estatura) VALUES(1,1,"2023-06-28","femenino","0388-686-5953","ESTRADA","belen_1995@outlook.es","Cintia Belen","1.53");
...
insert into ingredientes (ingre_nombre,ingre_estado) values('matambre de cerdo',1);
insert into ingredientes (ingre_nombre,ingre_estado) values('mozzarella',1);
insert into ingredientes (ingre_nombre,ingre_estado) values('Cebolla morada caramelizada',1);
insert into ingredientes (ingre_nombre,ingre_estado) values('Harina',1);
insert into ingredientes (ingre_nombre,ingre_estado) values('Azúcar',1);
insert into ingredientes (ingre_nombre,ingre_estado) values('Chocolate semi-amargo',1);
insert into ingredientes (ingre_nombre,ingre_estado) values('Chocolate cobertura semi-amargo',1);
...
insert into unidadmedida (nombre,estado) values('unidad',1);

insert into ingredientereceta (rec_id, ingre_id, id_unidadmedida, cantidad, estado) values(1, 1, 1, '400', 1);
insert into ingredientereceta (rec_id, ingre_id, id_unidadmedida, cantidad, estado) values(1, 2, 1, '200', 1);
insert into ingredientereceta (rec_id, ingre_id, id_unidadmedida, cantidad, estado) values(1, 3, 1, '1', 4);
insert into ingredientereceta (rec_id, ingre_id, id_unidadmedida, cantidad, estado) values(1, 4, 1, '50', 1);